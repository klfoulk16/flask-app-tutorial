...
if ENV == "dev":
    ...
    ] = "postgresql://postgres:postgres@localhost/flask-app-tutorial"
else:
    app.debug = False
    app.config[
        "SQLALCHEMY_DATABASE_URI"
...
app.config.update(
    ...
    MAIL_PORT=465,
    MAIL_USE_SSL=True,
    MAIL_USERNAME="flaskapptutorial@gmail.com",
...
app.secret_key = b'\xa2;Ra\x00t\xaa\xbe\x02s\x9a\x87\xe3\x8e\x17\xe8'
